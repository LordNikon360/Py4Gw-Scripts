...
class BasicWindow:
    ...
    loot_test_id_Items = True
    loot_test_collect_coins = True
    loot_test_collect_events = True
    loot_test_collect_items_white = True
    loot_test_collect_items_blue = True
    loot_test_collect_items_grape = True
    loot_test_collect_items_gold = True
    loot_test_collect_dye = True
    loot_test_sell_items = True
    loot_test_sell_items_white = True
    loot_test_sell_items_blue = True
    loot_test_sell_items_grape = True
    loot_test_sell_items_gold = True
    loot_test_sell_items_green = True
    loot_test_sell_materials = True
    loot_test_salvage_items = False
    loot_test_salvage_items_white = False
    loot_test_salvage_items_blue = False
    loot_test_salvage_items_grape = False
    loot_test_salvage_items_gold = False
